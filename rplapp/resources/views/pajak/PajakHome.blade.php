    ...
    <div class="p-12 ">
      <div class="flex justify-center items-center mb-8">
        <div class="card mr-4 border-4 p-6 rounded-lg">
          <img class="w-32 mt-auto" src="{{asset('images/upload.png')}}" alt="upload data" id="uploadButton" />
          <h6 class="text-center mt-3 font-bold">Upload</h6>
        </div>
        <div class="card border-4 p-6 rounded-lg">
          <img class="w-32 mt-auto" src="{{asset('images/download.png')}}" alt="download data" id="downloadButton" />
